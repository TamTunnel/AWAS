...
files['examples/implementations/javascript/awas-parser.js'] = '''/**
...
print("Created examples/implementations/javascript/awas-parser.js")
print(f"Length: {len(files['examples/implementations/javascript/awas-parser.js'])} characters")
